...
function saveBoard() {
  localStorage.setItem(`${STORAGE_PREFIX}${state.board.id}`, JSON.stringify(state.board));
}
...
function createBoard() {
  ...
  rememberBoard(board, board.editKey);
  navigateToBoard(board.id, board.editKey, "edit");
}
